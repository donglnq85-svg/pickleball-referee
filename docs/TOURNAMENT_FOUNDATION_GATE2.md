...
| Rules Version | Explicit source/label and optional scoring/format snapshot. `unknown` and absent format are valid until configured. New versions append; old ones remain. |
