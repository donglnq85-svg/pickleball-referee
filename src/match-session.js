...
function correctionSheet(s){
  ...
  return `<div class="ref-sheet-content"><h2>Sửa trạng thái</h2><p>Đối chiếu với thực tế trước khi lưu. Thao tác được ghi vào lịch sử và có thể hoàn tác.</p>
    <label>Điểm Đội A<input data-f="A" type="number" min="0" max="99" value="${s.currentGamePoints.A}"></label>
    <label>Điểm Đội B<input data-f="B" type="number" min="0" max="99" value="${s.currentGamePoints.B}"></label>
